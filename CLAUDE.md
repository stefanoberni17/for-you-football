...
- [ ] Applicare la migration `025_training_preferenze.sql` su Supabase (giorni/giornate/tempo nel setup): senza, il salvataggio del setup risponde "manca la migration 025"
