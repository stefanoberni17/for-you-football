...
### Da fare
- [ ] **FYF Training — prossimi passi:** (1) ✅ "Rigenera" col planner v2 provato da Ste; (2) ✅ review livelli applicata (PR #67); (3) settimana Everfit successiva per "Utente E." (dal 14/9) con token nuovo; (4) ✅ carico totale session-RPE/ACWR (PR #68) — da osservare sui dati reali quando ci saranno ≥2 settimane di sedute; (5) blocchi incompleti: 3 chiusi (alias nomi rinominati + "Tecnica a 2" attivi solo con compagno), restano Headball (attivare gli 11 esercizi `attrezzatura: headball`? si vedrebbero solo con la Headball nel setup) e Barbell Deadlift (fuori per scelta: PRO1 resta incompleto o si mappa su RDL?) — decisione di Ste; (6) video di visione: collegarli all'esercizio nel player — Ste lo fa dopo; (7) apertura del modulo ad altri utenti test (flag via SQL) prima di pensare a UI/paywall.
