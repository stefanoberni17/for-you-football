...
- Player: bottone "Esercizio precedente" (tap sbagliato), "Esercizio completato" al posto di "ultima serie fatta", legenda RPE con 1-3 / 5 / 7-8 / 10, "Non era l'ultima: torna alla serie" durante l'ultimo recupero. **Scala RPE 1-10 predefinita (21/9, Ste: "era meglio la scala 1-10 come prima")** nel player e nell'EMOM, le 3 scelte Facile/Giusta/Durissima restano un'opzione (`localStorage['player.rpeDettaglio']`, `'0'` = tre scelte). **Pulsanti tagliati (21/9):** la pagina seduta e la chat del preparatore erano alte `100vh`: su Safari iOS con la barra del browser sfora sotto il bordo visibile e la riga sotto la CTA (Esercizio precedente / Salta esercizio, "Non era l'ultima") finiva dietro la tab bar → utility `h-dvh-screen` (100dvh con ripiego), la stessa di `/chat`.
