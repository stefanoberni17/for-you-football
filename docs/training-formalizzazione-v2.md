...
| **Intensiva** | drop jumps, depth jumps, salti in lungo/triplo, single leg drop | **30-160 contatti (alzato da Ste a set 2026: Pliometria B1 69, B2 96, A1 158)** **[STE ✅]** | **solo A/PRO** | Drop Jump 3×2-3 rec 60" · Broad jump 3-4×2 rec 60" · Single leg lateral drop jump 2×10 rec 60" · Salto triplo + sprint 4-6 rec 30-60" · Reverse drop jumps 3×12 → 5×20 rec 120" |
