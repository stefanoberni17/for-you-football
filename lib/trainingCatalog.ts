...
export const ESERCIZI: TrainingExercise[] = [
  ...
  // Ordine della scala (Ste, 15/9): l'arciere INCLINATO viene prima dell'arciere a terra (il rialzo riduce il carico).
  // Gli id restano quelli di sempre: i risultati salvati sono legati all'id, non al gradino.
  { id: 'push-4', nome: 'Piegamenti arciere inclinati', area: 'spinta', gradino: 3, unita: 'reps' , descrizione: "Mani molto larghe su un rialzo (panca/gradino): scendi spostando il peso su un braccio mentre l'altro si distende di lato. Alterna i lati. L'inclinazione riduce il carico: è il primo passo verso l'arciere a terra." },
  { id: 'push-3', nome: 'Piegamenti arciere', area: 'spinta', gradino: 4, unita: 'reps' , descrizione: "Mani molto larghe a terra: scendi spostando il peso su un braccio mentre l'altro si distende di lato. Alterna i lati. Il braccio di lavoro fa quasi tutto, l'altro guida. Prepara il lavoro a un braccio." },
  { id: 'push-5', nome: 'Piegamenti 1 braccio — negative', area: 'spinta', gradino: 5, unita: 'reps', perLato: true , descrizione: "Un braccio dietro la schiena, piedi larghi: SOLO la discesa, lenta (4-5 secondi), poi rimettiti in posizione con due braccia. Costruisce la forza eccentrica per il piegamento a un braccio. Alterna sempre: una a destra, una a sinistra." },
  { id: 'push-6', nome: 'Piegamenti 1 braccio inclinati', area: 'spinta', gradino: 6, unita: 'reps', perLato: true , descrizione: "Piegamento a un braccio con le mani su un rialzo. Piedi molto larghi, corpo rigido, spalla lontana dall'orecchio. Scendi controllato, spingi senza ruotare il busto. Alterna sempre: una a destra, una a sinistra." },
  { id: 'push-7', nome: 'Piegamenti 1 braccio orizzontali', area: 'spinta', gradino: 7, unita: 'reps', perLato: true , descrizione: "Il piegamento a un braccio completo a terra. Piedi larghi, core durissimo, il busto resta parallelo al pavimento: se ruoti vistosamente, torna al gradino prima. Alterna sempre: una a destra, una a sinistra." },
  { id: 'push-8', nome: 'Piegamenti 1 braccio declinati', area: 'spinta', gradino: 8, unita: 'reps', perLato: true, videoUrl: 'https://youtube.com/shorts/Lbw-eJf6Jn4' , descrizione: "Piegamento a un braccio con i piedi su un rialzo: più carico sulla spalla. Solo con il gradino precedente pulito. Alterna sempre: una a destra, una a sinistra." },
