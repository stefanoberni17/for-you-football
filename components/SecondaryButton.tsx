...
export default function SecondaryButton({
  ...
  const base = `inline-flex items-center justify-center gap-2 font-semibold text-forest-700 bg-white border border-forest-200 rounded-xl hover:bg-forest-50 active:scale-[0.99] transition-all disabled:opacity-50 disabled:cursor-not-allowed ${sizeCls} ${className}`;
